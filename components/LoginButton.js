...
export default function LoginButton() {
  ...
  // ĐÃ ĐĂNG NHẬP → Hiển thị avatar + menu hồ sơ
  if (user) {
    return (
      <div className="relative" ref={menuRef}>
        ...
        {menuOpen && (
          <div className="absolute right-0 mt-2 w-60 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-xl p-2">
            ...
            <div className="h-px bg-gray-200 dark:bg-gray-700 my-1" />
            <button onClick={logout} className="w-full text-left px-3 py-2 text-sm rounded hover:bg-gray-100 dark:hover:bg-gray-800">
              Đăng xuất
            </button>
          </div>
        )}
