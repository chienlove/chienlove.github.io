...
export default function Comments({ postId, postTitle }) {
  ...
  return (
    <div className="mt-6">
      ...
      {/* Khung nhập bình luận đặt trong CARD RIÊNG */}
<div className="mb-4 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-sm p-3 sm:p-4">
  {!me ? (
