            ...
            <div className="space-y-4">
              {category.apps.map((app) => (
                <Link href={`/${app.slug}`} key={app.id}>
                  <a className="flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-lg transition">
                    {/* Icon */}
                    <div className="w-14 h-14 rounded-2xl overflow-hidden border border-gray-300 dark:border-gray-600 flex-shrink-0">
                      <img
