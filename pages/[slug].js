              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white">
                    {app.name} 
                    {app.version && <small className="ml-2 text-lg text-gray-600 dark:text-gray-300">v{app.version}</small>}
                  </h1>
                  {app.author && (
              ...
              <div className="w-full h-64 md:h-80 bg-gray-100 dark:bg-gray-700">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    e.target.className = 'w-full h-full object-contain p-8 bg-gray-100 dark:bg-gray-700';
                  }}
                />
              </div>
            )}
                      ...
                      <div key={i} className="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                        <img 
                          ...
                          onError={(e) => {
                            ...
                            e.target.className = 'w-full h-48 object-contain p-4 bg-gray-100 dark:bg-gray-700';
                          }}
                        />
                      </div>
                    ))}
