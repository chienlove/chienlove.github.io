document.addEventListener('DOMContentLoaded', () => {
  ...
  if (window.netlifyIdentity) {
    ...
    // 14. HIỂN THỊ NỘI DUNG COLLECTION
    ...
    // 16. THÊM BÀI VIẾT MỚI - THƯ MỤC THÔNG THƯỜNG
    ...
    // 17. THÊM ENTRY MỚI CHO COLLECTION
...
`;
  ...
  // 27. HIỂN THỊ MODAL CHỈNH SỬA COLLECTION ENTRY
...
`;
  ...
  // 28. HIỂN THỊ MODAL CHỈNH SỬA ĐƠN GIẢN
