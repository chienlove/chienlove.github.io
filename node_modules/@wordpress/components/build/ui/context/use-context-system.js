...
function useContextSystem(props, namespace) {
  ...
  const classes = cx((0, _getStyledClassNameFromKey.getStyledClassNameFromKey)(namespace), props.className); // Provides the ability to customize the render of the component.
