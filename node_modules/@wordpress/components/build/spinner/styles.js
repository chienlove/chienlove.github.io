...
exports.StyledSpinner = exports.SpinnerTrack = exports.SpinnerIndicator = void 0;
...
const spinAnimation = (0, _react.keyframes)`
	from {
 ...
 `;
const StyledSpinner = (0, _base.default)("svg", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq2"
} : {
  target: "ea4tfvq2",
  label: "StyledSpinner"
