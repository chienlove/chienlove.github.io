...
const KeyboardAvoidingView = _ref => {
  let {
    parentHeight,
    style,
  ...
  (0, _element.useEffect)(() => {
    _reactNativeSafeArea.default.getSafeAreaInsetsForRootView().then(_ref2 => {
      let {
        safeAreaInsets
      } = _ref2;
  ...
  function onKeyboardWillShow(_ref4) {
    let {
      endCoordinates
    } = _ref4;
  ...
  function onKeyboardWillHide(_ref5) {
    let {
      duration,
      startCoordinates
    } = _ref5;
    ...
    const animatedListenerId = animatedHeight.addListener(_ref6 => {
      let {
        value
      } = _ref6;
