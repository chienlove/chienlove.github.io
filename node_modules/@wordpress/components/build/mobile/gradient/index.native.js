...
function getGradientColorGroup(gradientValue) {
  ...
  return [].concat(...((_gradientParser$parse = _gradientParser.default.parse(modifiedGradientValue)) === null || _gradientParser$parse === void 0 ? void 0 : _gradientParser$parse.map(gradient => {
    var _gradient$colorStops;

    return (_gradient$colorStops = gradient.colorStops) === null || _gradient$colorStops === void 0 ? void 0 : _gradient$colorStops.map((color, index) => {
      const {
        type,
        value,
        length
