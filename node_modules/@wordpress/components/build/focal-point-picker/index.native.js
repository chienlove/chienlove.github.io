...
function FocalPointPicker(props) {
  ...
  const panResponder = (0, _element.useMemo)(() => _reactNative.PanResponder.create({
    ...
    onPanResponderRelease: event => {
      ...
      onChange({
        x: (0, _math.clamp)(x / (containerSize === null || containerSize === void 0 ? void 0 : containerSize.width), 0, 1).toFixed(2),
        y: (0, _math.clamp)(y / (containerSize === null || containerSize === void 0 ? void 0 : containerSize.height), 0, 1).toFixed(2)
