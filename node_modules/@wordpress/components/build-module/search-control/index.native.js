...
import platformStyles from './platform-style.scss'; // Merge platform specific styles with the default styles.

const baseStyles = { ...allStyles
};

for (const selector in platformStyles) {
  baseStyles[selector] = { ...baseStyles[selector],
...
function SearchControl(_ref) {
  ...
  function renderLeftButton() {
    const button = !isIOS && isActive ? createElement(Button, {
      ...
      fill: iconStyle === null || iconStyle === void 0 ? void 0 : iconStyle.color
    });
  ...
  function renderRightButton() {
    let button; // Add a View element to properly center the input placeholder via flexbox.
