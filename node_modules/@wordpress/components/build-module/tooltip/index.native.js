...
const Tooltip = _ref => {
  ...
  const tooltipBoxStyles = [styles.tooltip__box, horizontalPosition === 'right' && styles['tooltip--rightAlign'], {
    ...
    shadowColor: (_styles$tooltip__shad = styles.tooltip__shadow) === null || _styles$tooltip__shad === void 0 ? void 0 : _styles$tooltip__shad.color,
    shadowOffset: {
      height: 2,
      width: 0
    },
  ...
  return createElement(Fragment, null, cloneElement(children, {
    ref: referenceElementRef,
    onLayout: getReferenceElementPosition
  }), createElement(Fill, null, createElement(View, {
