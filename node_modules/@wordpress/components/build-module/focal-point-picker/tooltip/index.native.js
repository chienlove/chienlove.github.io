...
function Label(_ref2) {
  ...
  useEffect(() => {
    ...
    startAnimation();
  }, [animationValue, visible]); // Transforms rely upon onLayout to enable custom offsets additions.
  ...
  const tooltipStyles = [styles.tooltip, {
    shadowColor: (_styles$tooltipShadow = styles.tooltipShadow) === null || _styles$tooltipShadow === void 0 ? void 0 : _styles$tooltipShadow.color,
    shadowOffset: {
      width: 0,
      height: 2
    },
