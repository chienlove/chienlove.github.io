...
export const Root = _styled("span", process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z8"
} : {
  target: "e1j5nr4z8",
  label: "Root"
...
export const Viewbox = _styled("span", process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z7"
} : {
  target: "e1j5nr4z7",
  label: "Viewbox"
...
const Stroke = _styled("span", process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z6"
} : {
  target: "e1j5nr4z6",
  label: "Stroke"
