...
function UnitControl(_ref) {
  ...
  const getAnchor = useCallback(() => anchorNodeRef !== null && anchorNodeRef !== void 0 && anchorNodeRef.current ? findNodeHandle(anchorNodeRef === null || anchorNodeRef === void 0 ? void 0 : anchorNodeRef.current) : undefined, // Disable reason: this should be fixed by the native team.
  // It would be great if this could be done in the context of
  // https://github.com/WordPress/gutenberg/pull/39218
  // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  const renderUnitPicker = useCallback(() => {
    ...
    return createElement(View, {
      ...
      ref: anchorNodeRef
    }, renderUnitButton, hasUnits(units) && (units === null || units === void 0 ? void 0 : units.length) > 1 ? createElement(Picker, {
      ref: pickerRef,
      options: units,
