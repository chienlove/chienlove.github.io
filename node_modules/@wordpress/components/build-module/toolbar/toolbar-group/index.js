...
function ToolbarGroup(_ref) {
  ...
  const finalClassName = classnames( // Unfortunately, there's legacy code referencing to `.components-toolbar`
  ...
  return createElement(ToolbarGroupContainer, _extends({
    className: finalClassName
  }, props), (_controlSets = controlSets) === null || _controlSets === void 0 ? void 0 : _controlSets.flatMap((controlSet, indexOfSet) => controlSet.map((control, indexOfControl) => createElement(ToolbarButton, _extends({
