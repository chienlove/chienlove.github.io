 ...
 * ```
 */
declare const ConnectedTooltip: import("../context").WordPressComponent<"div", Omit<import("reakit").PopoverInitialState, "modal"> & Pick<Partial<import("reakit").TooltipState>, "unstable_timeout"> & import("../utils/types").PopperProps & Pick<import("..").ShortcutProps, "shortcut"> & {
