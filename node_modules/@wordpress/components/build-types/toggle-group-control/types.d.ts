...
type ToggleGroupControlAsButtonContext = {
    isDeselectable: true;
} & Pick<RadioStateReturn, 'state' | 'setState'>;
export type ToggleGroupControlContextProps = Pick<ToggleGroupControlProps, 'isBlock' | 'size'> & {
    baseId: string;
...
export type ToggleGroupControlMainControlProps = Pick<ToggleGroupControlProps, 'children' | 'isAdaptiveWidth' | 'label' | 'size'> & {
    onChange: (value: ReactText | undefined) => void;
    value?: ReactText;
};
export {};
