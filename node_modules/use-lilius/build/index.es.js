...
var useLilius = function (_a) {
    ...
    var _g = useState(initialViewing), viewing = _g[0], setViewing = _g[1];
    var viewToday = useCallback(function () { return setViewing(startOfToday()); }, [setViewing]);
    var viewMonth = useCallback(function (month) { return setViewing(function (v) { return setMonth(v, month); }); }, []);
    var viewPreviousMonth = useCallback(function () { return setViewing(function (v) { return subMonths(v, 1); }); }, []);
    var viewNextMonth = useCallback(function () { return setViewing(function (v) { return addMonths(v, 1); }); }, []);
    var viewYear = useCallback(function (year) { return setViewing(function (v) { return setYear(v, year); }); }, []);
    var viewPreviousYear = useCallback(function () { return setViewing(function (v) { return subYears(v, 1); }); }, []);
    var viewNextYear = useCallback(function () { return setViewing(function (v) { return addYears(v, 1); }); }, []);
    var _h = useState(initialSelected.map(clearTime)), selected = _h[0], setSelected = _h[1];
    var clearSelected = function () { return setSelected([]); };
    var isSelected = useCallback(function (date) { return selected.findIndex(function (s) { return isEqual(s, date); }) > -1; }, [selected]);
    ...
    var toggle = useCallback(function (date, replaceExisting) { return (isSelected(date) ? deselect(date) : select(date, replaceExisting)); }, [deselect, isSelected, select]);
